...
namespace RentalCar.Application.Abstractions.Services.Cars
{
    ...
    {
        Task<CarDetailsDto?> GetCarDetailAsync(int CarId, string? userId, bool isAdmin, CancellationToken cancellationToken = default);
        ...
        Task<List<Car>> RecommendByCriteriaAsync(
            List<Car> candidates,
